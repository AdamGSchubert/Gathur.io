...
namespace Gathur.Utils
{
	...
	public static class DbUtils
	{
		...
		public static string GetBit(SqlDataReader reader, string column)
		{
			int ordinal = int.Parse(column);
			...
			return reader.GetSqlBinary(ordinal).ToString();
		}
